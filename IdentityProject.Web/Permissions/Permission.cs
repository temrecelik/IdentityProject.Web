namespace IdentityProject.Web.Permissions
{
    public static class Permission
    {
        ...
        public const string Write = "Permission.Stock.Create";
        ...
        public static class Order
        {
            ...
            public const string Write = "Permission.Order.Create";
        ...
        public static class Catalog
        {
            ...
            public const string Write = "Permission.Catalog.Create";
